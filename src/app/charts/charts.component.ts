    ...
    this.chartData = [
      {
        ...
        series: [
          ...
          // {
          //   name: timeLine[this.getTimeLine(timeLine, 2)],
          //   value:
          //     data.timeseries[timeLine[this.getTimeLine(timeLine, 2)]]
          //       .confirmed,
          // },
          {
      ...
      },
      {
        ...
        series: [
          ...
          //   name: timeLine[this.getTimeLine(timeLine, 2)],
          //   value:
          //     data.timeseries[timeLine[this.getTimeLine(timeLine, 2)]].deaths,
          // },
          {
            name: timeLine[this.getTimeLine(timeLine, 1.8)],
            value:
